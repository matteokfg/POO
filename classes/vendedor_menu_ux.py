...
# VENDEDOR NAO TEM CARRINHO
    ...
    def ux_tabela_vendedor(self):
        ...
        rowdata = []
# COMO LISTAR APENAS OS PRODUTOS DA LOJA/VENDEDOR
        for prod in produto.listar():
            connector = Connector(path_banco)
            result = connector.procurar("Loja", prod["codigo_loja"], coluna="codigo") # RETIRAR?
            if prod["codigo_loja"] == CODIGO_LOJA:  #self.var_loja?
